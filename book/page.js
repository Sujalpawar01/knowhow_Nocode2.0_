    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-black flex justify-center items-center py-12">
                <div className="w-full max-w-xl p-8 bg-gray-800 shadow-xl rounded-lg">
                    <h1 className="text-3xl font-semibold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-green-400 to-purple-600 mb-6">Book an Appointment</h1>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        {/* Service Option Dropdown */}
                        <div>
                            <label htmlFor="option" className="block text-sm font-medium text-gray-300">
                                Select Service
                            </label>
                            <select
                                id="option"
                                ...
                                value={formData.option}
                                onChange={handleChange}
                                className="mt-1 block w-full h-12 bg-gray-700 border border-gray-600 text-white rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                required
                            >
