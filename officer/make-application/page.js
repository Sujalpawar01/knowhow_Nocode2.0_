...
const ServiceFormPage = (req) => {
  ...
  return (
    <div className="main h-screen w-full relative bg-gray-100 pt-10">
      <div className="form-container shadow-xl border rounded-xl h-[70%] justify-center w-1/2 p-6 bg-white mx-auto flex flex-col">
        <h1 className="font-bold text-3xl mb-8 mx-auto text-center text-gray-800">Service Form</h1>

        <label className="text-xl px-6 mb-2 text-gray-700">Service</label>
        <input
          type="text"
          name="service"
          value={formData.service}
          onChange={handleChange}
          placeholder="Enter the service name"
          className="p-3 mx-auto w-11/12 mb-6 border-2 border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        />

        <label className="text-xl px-6 mb-2 text-gray-700">Done Date</label>
        <input
          type="date"
          name="doneDate"
          value={formData.doneDate}
        ...
        <label className="text-xl px-6 mb-2 text-gray-700">Status</label>
        <select
          name="status"
          value={formData.status}
          onChange={handleChange}
        ...
        <button
          type="button"
          onClick={handleSubmit}
          className="text-white bg-gradient-to-r from-blue-500 to-blue-700 hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 mt-5 transition w-11/12 mx-auto"
        >
          Submit
        </button>
      </div>
