...
const page = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="main h-screen w-full relative bg-black pt-10">
        <div className="container shadow-xl border rounded-xl h-[82%] justify-center w-1/2 p-3 px-6 py-6 bg-gray-00 mx-auto flex flex-col">
          <h1 className="text-3xl font-semibold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-green-400 to-purple-600 mb-6">Register as Army</h1>

          <label className="text-xl px-6 mb-2 text-white">Position</label>
          <select
            name="position"
            value={formdata.position}
            onChange={handleChange}
            className="p-2 mx-auto w-11/12 mb-6 border border-gray-900 rounded-md bg-gray-700 text-white"
          >
            <option value="">Select Position</option>
            <option value="Military Personnel">Military Personnel</option>
            <option value="Jawan">Jawan</option>
          ...
          <label className="text-xl px-6 mb-2 text-gray-300">Aadhar Card No</label>
          <input
            type="text"
            name="aadharCardNo"
            value={formdata.aadharCardNo}
            onChange={handleChange}
            className="p-2 mx-auto w-11/12 mb-6 border border-gray-600 rounded-md bg-gray-700 text-white"
          />

          <label className="text-xl px-6 mb-2 text-gray-300">Defence ID No</label>
          <input
            type="text"
            name="defenceIdNo"
            value={formdata.defenceIdNo}
          ...
          <label className="text-xl px-6 mb-2 text-gray-300">ID Card (PDF)</label>
          <input
            type="file"
            name="idCard"
            accept="application/pdf"
          ...
          <p className="size-8 w-64 mb-4 text-gray-400">
            Already a user?<span className="text-blue-600"> Login</span>
          </p>
        </div>
      </div>
