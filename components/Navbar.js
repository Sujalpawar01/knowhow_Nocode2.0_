...
const Navbar = () => {
  ...
  return (
    <nav className="w-full p-5 flex justify-between px-28 ">
      <div className="con text-2xl font-bold text-white">
        <span>R</span>
        <span className="text-red-500">T</span>
        <span>O</span>
      </div>
      <ul className="flex text-lg gap-4 items-center text-white">
        <li className="cursor-pointer" onClick={() => router.push('/home')}>Home</li>
        <li className="cursor-pointer">About Us</li>
        {registerid === "1" && <li onClick={() => router.push("/login")}>Login</li>}
        {registerid !== "1" && (
          <li>
            ...
            {dropdownOpen && (
              <div
                id="dropdown"
                className="z-10 bg-gray-700 divide-y divide-gray-600 rounded-lg shadow w-44 absolute"
              >
                <ul className="py-2 text-sm text-gray-200">
                  <li>
                    <a
                      href="/generate-qr"
                      className="block px-4 py-2 hover:bg-gray-600 dark:hover:bg-gray-500 dark:hover:text-white"
                    >
                      Generate QR
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      onClick={() => signout()}
                      className="block px-4 py-2 hover:bg-gray-600 cursor-pointer dark:hover:bg-gray-500 dark:hover:text-white"
                    >
                      Sign out
                    </a>
                  </li>
